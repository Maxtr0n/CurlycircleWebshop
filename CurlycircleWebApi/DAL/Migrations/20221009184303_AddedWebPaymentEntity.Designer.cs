...
namespace DAL.Migrations
{
    ...
    [Migration("20221009184303_AddedWebPaymentEntity")]
    partial class AddedWebPaymentEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "4db0f2f8-c0b1-443a-9683-5632f1a42222",
                            Name = "Admin",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "5bf589db-0cf0-4b75-8b99-41626179ef20",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "78ae3574-20bf-4af3-b0bc-ef3d59001865",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJrU0sr30dPrf79aba6MYkm5B7RK/N5PD//rcrPVlIkPTnXnEuVOqjIcHkj5zDmXWQ==",
                            PhoneNumber = "06302217831",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "45e9ca3c-b4ff-4b2e-8f74-7c12c5ce57ff",
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a003ef6d-2e6a-4793-8825-d6496f1926ae",
                            Email = "user@user.com",
                            EmailConfirmed = false,
                            FirstName = "Béla",
                            LastName = "Kovács",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEDhQXH3KJaxUCcTiLpbId1puN8rZ0KrjRvEBc1UP7ZRpwgBbJ0LkEyboNlZ2X2gYxQ==",
                            PhoneNumber = "06302217831",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "1a2c683b-efc0-404e-91fe-e3111e8d7bfc",
                            TwoFactorEnabled = false,
                            UserName = "user"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.WebPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseHiLo(b.Property<int>("Id"), "webpaymentseq");

                    b.Property<Guid?>("BarionPaymentId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("OrderId")
                        .HasColumnType("int");

                    b.Property<string>("POSTransactionId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("WebPayments", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.WebPayment", b =>
                {
                    b.HasOne("Domain.Entities.Order", "Order")
                        .WithOne("WebPayment")
                        .HasForeignKey("Domain.Entities.WebPayment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
